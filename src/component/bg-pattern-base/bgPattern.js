...
class BgPattern extends React.Component {
    ...
    render() {
        ...
        return <div>
            <svg width={width} opacity={opacity} fill={bgColor} enableBackground="new 0 0 793 555" version="1.1"
                 viewBox="0 0 793 555" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
                <g>
                ...
                <polygon points="481.708 184.707 634.108 272.707 634.108 97.307 481.708 9.307" className="st0"/>
            </svg>
