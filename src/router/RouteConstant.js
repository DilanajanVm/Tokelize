...
export const ACCESS_TOKEN = "2c8dc2f5a6529fdb2536348a55fe4cd200";
export const BASIC_AUTH = "cmVnaXN0ZXJlZF9kb25vcjo=";
export const REFRESH_TOKEN = "6c66b0";
export const VERIFY_CODE = "RtEw67ZUI6bg";

export const CHARITY_BASE_URL = "https://mydonate-charity.ceyentra.lk";
export const RESOURCE_SERVER_URL = "https://mydonate-resources.ceyentra.lk";
